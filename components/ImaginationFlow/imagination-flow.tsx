            ...
            <div className={styles.feature_area}>
                <div className={styles.straight_grids}>
                    <div className={styles.indi_feature}>
                        ...
                        <p>At Buidlfy, we aim to give our users the power to design quickly and effectively. You can add any design element just by clicking on it.</p>
                    ...
                    <div className={styles.indi_feature}>
                        ...
                        <p>Our purpose with words is to convey our thoughts and ideas to those who will read them.</p>

                        <p>We are working on designing attractive typefaces that will leave a lasting impression on the hearts of readers.</p>
                    </div>
                </div>
                <div className={styles.straight_grids}>
                    <div className={styles.indi_feature}>
                        ...
                        <h3>Color Styles</h3>
                        <p>Fill in the colours of your imagination in your designs with our simple tools and thus paint the future of the web with us.</p>
                    </div>
                    <div className={styles.indi_feature_left}>
                        <div className={styles.inner_layer}>
                            <h3>Best Design System</h3>
                            <p>Create web pages quickly with your pre-made UI design elements such as buttons, inputs, forms, modals, notifications, tooltips, and so on...</p>
                        </div>
                        <Image src={DesignSystem} alt="designsystem" />
                    </div>
                    <div className={styles.indi_feature_central}>
                        <Image src={GradientLeaf} alt="GradientLeaf" />
                        <p className={styles.gradient_blue_button}>Build For Free <ArrowRight /></p>
                    </div>
                </div>
                <div className={styles.straight_grids}>
                    <div className={styles.indi_feature}>
