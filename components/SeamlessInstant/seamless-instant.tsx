...
function SeamlessInstant() {
    return (
        <div className={styles.main_area}>
            ...
            <h5 className={styles.desc}>Start from scratch or select over 100 stunning templates to create a stunning wesite and create a stunning website in sectonds.</h5>
