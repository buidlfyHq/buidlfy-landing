...
function ShipSite() {
    return (
        <div className={styles.main_area}>
            ...
            <h5 className={styles.desc}>Own & Sell your designs and reach millions of buyers or promote other artists on the Buidlfy’s marketplace.</h5>
            <div className={styles.blue_bg}>
                <div className={styles.left_side}>
                    <Image src={Tickmark} alt="Tickmark" />
                    <h2>Ship sites to your users</h2>
                    <p>Own & Sell your designs and reach millions of buyers or promote other artists on the Buidlfy’s marketplace. </p>
                    <p>What your team needs to get done, we offer an fabulously rich builder to do it swiftly, and at ease with your whole organization in harmony.</p>
