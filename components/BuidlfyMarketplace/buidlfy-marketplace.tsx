...
function BuidlfyMarketplace() {
    return (
        <div className={styles.main_area}>
            ...
            <h5 className={styles.desc}>Own and sell your creations to millions of buyers, or to promote other artists on the Buidlfy marketplace.</h5>
            ...
            <div className={styles.bottom_area}>
                <div className={styles.deploy_box}>
                    <div className={styles.inner_layer}>
                        ...
                        <p>You can connect your wallet easily to buy and sell designs easily. </p>
                    </div>
